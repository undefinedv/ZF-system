<%@ Page Language="vb" AutoEventWireup="false" Codebehind="js_ttksq_rep.aspx.vb" Inherits="zjdx.js_ttksq_rep"%>
											...
											<tr>
												<td colSpan="2" width="100%">
													<TABLE id="Table3" width="100%">
														<TR>
															<TD align="center" width="101" height="87">
																<P>教学班</P>
																<P>学生意见</P>
															</TD>
															<TD colspan="3" height="87">
																<P>&nbsp;&nbsp;&nbsp;说明：教学班级全体学生在调课或补课时段不存在课程冲突现象<br>
																</P>
