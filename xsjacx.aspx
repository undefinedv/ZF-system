...
<div id="main"> 
    <div id="title"> 
      <div id="title_l"></div> 
      <div id="title_m">学生教案查询</div> 
      <div id="title_r"></div> 
    </div> 
    <div id="content">	
  <TABLE id="Table1" width="100%">
    <TR>
				        <TD height="24" class="trbg1"><b>教案列表:</b> </TD>
			</TR>
			<TR>
...
<AlternatingItemStyle CssClass="datagrid1212"></AlternatingItemStyle>
						<Columns>
							...
							<asp:BoundColumn DataField="jaqcsj" HeaderText="上传时间"></asp:BoundColumn>
			...
			<TR>
				<TD align="center"><asp:button id="Button3" runat="server" Text="查　看" CssClass="button"></asp:button> <asp:button id="Button2" runat="server" Text="关　闭" CssClass="button"></asp:button></TD>
			</TR>
		</TABLE></div> 
</div> 
<div id="bottom"> 
