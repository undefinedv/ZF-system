<%@ Page Language="vb" AutoEventWireup="false" Codebehind="js_tykwlcj.aspx.vb" Inherits="zjdx.js_tykwlcj" %>
			...
			<div id="main">
				...
				<div id="content">
					...
					<table class="search_content" width="100%">
						<TBODY>
							<tr>
								<TD><asp:label id="Label1" runat="server">项目名称</asp:label><asp:dropdownlist id="ddl_dlmc" runat="server" AutoPostBack="True" Width="144px"></asp:dropdownlist><asp:label id="lbl_xb" runat="server">教学班：</asp:label><asp:dropdownlist id="ddl_xkkh" runat="server" AutoPostBack="True" Width="504px"></asp:dropdownlist><ASP:BUTTON id="BUTTON3" runat="server" Text="查询" Width="80px" CssClass="button"></ASP:BUTTON></TD>
								<td align="right">&nbsp;</td>
							</tr>
						</TBODY>
					</table>
