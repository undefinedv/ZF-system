<%@ Page Language="vb" AutoEventWireup="false" Codebehind="bzrpj_js.aspx.vb" Inherits="zjdx.bzrpj_js"%>
		...
		<FORM id="Form1" method="post" runat="server">
			...
			<div id="main">
				...
				<div id="content">亲爱的同学：<BR>
					...
					教务处
					<HR>
					评价：<ASP:DROPDOWNLIST id="pjkc" runat="server" AutoPostBack="True" Width="200px"></ASP:DROPDOWNLIST>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<TABLE id="Table2" cellSpacing="0" cellPadding="0" border="0">
						...
						<TR>
							<TD height="66"><br>
								其他评价与建议（限50字，可不填）：<br>
								<asp:textbox id="pjxx" runat="server" Width="500px" Visible="true" TextMode="MultiLine" Height="100px"
