		   ...
		   function Change1()
		    ...
		    function button5_click(){
		       if (document.getElementById("djb").value!="")
		          {
		           if (confirm("录入过第" + document.getElementById("djb").value +" 遍，是否重录？")==true)
		            __doPostBack('btn_ts','')
		           }
		    } 
			...
			<div id="main">
				...
				<div id="content">
					<div class="search_content">课程名称：
						...
						<asp:label id="pjbh" runat="server"></asp:label>&nbsp; 总人数：
						<asp:label id="zrs" runat="server"></asp:label>&nbsp; 已录入人数：
						<asp:label id="rs" runat="server"></asp:label>&nbsp;&nbsp;
						<asp:label id="Label1" runat="server"></asp:label>
					</div>
					<div class="search_content">
						缓考人数：
						<asp:label id="hkrs" runat="server"></asp:label>&nbsp; 缓考学号：
														...
														<TD>
															<table id="Table1" height="100%" cellSpacing="0" cellPadding="0" width="100%" border="0">
																<tr id="Link" style="DISPLAY: none">
																	<td class="SelectedTabStrip" id="TabStrip1" noWrap height="21" runat="server"><asp:linkbutton id="Linkbutton1" CssClass="NoFace" Runat="server">第一遍</asp:linkbutton></td>
																	<td class="TabSeparator" width="4" height="21">&nbsp;</td>
																	<td class="TabStrip" id="TabStrip2" noWrap height="21" runat="server"><asp:linkbutton id="Linkbutton2" CssClass="NoFace" Runat="server">第二遍</asp:linkbutton></td>
																	<td class="TabSeparator" width="4" height="21">&nbsp;</td>
																				...
																				<td vAlign="top" noWrap width="70%">
																					<table id="Table9" height="56" cellSpacing="0" cellPadding="1" width="100%" align="center"
																						...
																						<TR>
																							...
																							<TD id="TD55" width="75" runat="server" Visible="false">第十七题</TD>
																					...
																					<div id="tool"><asp:button id="btn_bc" runat="server" CssClass="button" Width="65px" Text="保 存" style="DISPLAY:none"></asp:button><asp:button id="btn_tj" runat="server" CssClass="button" Width="65px" Text="录入完毕"></asp:button><input type="button" value="关  闭" class="button" Width="65px" onclick="window.opener=null;window.close();"></div>
																				</td>
																			</tr>
																			<tr id="Tr1" bgColor="#ffffff" runat="server">
																				<TD vAlign="top" noWrap width="70%"><FONT face="宋体">
																						<table id="Table9" height="56" cellSpacing="0" cellPadding="1" width="100%" align="center"
																							border="0">
																							<TBODY>
																								<tr>
																									...
																									<div class="search_content">姓名：
																										<asp:label id="xme" runat="server"></asp:label>&nbsp;&nbsp;性别：
																										<asp:label id="xbe" runat="server"></asp:label>&nbsp; 专业：
																										<asp:label id="zymce" runat="server"></asp:label>&nbsp;班级：
																										<asp:label id="xzbe" runat="server"></asp:label></div>
																								</tr>
																								<tr>
																									<td id="TDE1" width="55" runat="server">题号：</td>
																									<TD id="TDE11" width="71" runat="server" Visible="false">第一题</TD>
																									<TD id="TDE12" width="72" runat="server" Visible="false">第二题</TD>
																									<TD id="TDE13" width="76" runat="server" Visible="false">第三题</TD>
																									<TD id="TDE14" width="74" runat="server" Visible="false">第四题</TD>
																									<TD id="TDE15" width="76" runat="server" Visible="false">第五题</TD>
																									<TD id="TDE16" runat="server" Visible="false">第六题</TD>
																								</tr>
																								<TR>
																									<TD id="TDE2" width="55" runat="server">成绩：</TD>
																								...
																								<TR>
																									<TD id="TDE3" width="55" height="16" runat="server" Visible="false">题号：</TD>
																									<TD id="TDE31" width="71" height="16" runat="server" Visible="false">第七题</TD>
																									<TD id="TDE32" width="72" height="16" runat="server" Visible="false">第八题</TD>
																									<TD id="TDE33" width="76" height="16" runat="server" Visible="false">第九题</TD>
																									<TD id="TDE34" width="74" height="16" runat="server" Visible="false">第十题</TD>
																									<TD id="TDE35" width="76" height="16" runat="server" Visible="false">第十一题</TD>
																									<TD id="TDE36" height="16" runat="server" Visible="false">第十二题</TD>
																								</TR>
																								<TR>
																									<TD id="TDE4" width="55" height="20" runat="server" Visible="false">成绩：</TD>
																								...
																								<TR>
																									<TD id="TDE5" width="55" runat="server" Visible="false">题号：</TD>
																									<TD id="TDE51" width="71" runat="server" Visible="false">第十三题</TD>
																									<TD id="TDE52" width="72" runat="server" Visible="false">第十四题</TD>
																									<TD id="TDE53" width="76" runat="server" Visible="false">第十五题</TD>
																									<TD id="TDE54" width="74" runat="server" Visible="false">第十六题</TD>
																									<TD id="TDE55" width="76" runat="server" Visible="false">第十七题</TD>
																									<TD id="TDE56" runat="server" Visible="false">第十八题</TD>
																								</TR>
																								<TR>
																									<TD id="TDE6" width="55" runat="server" Visible="false">成绩：</TD>
																						...
																						<div id="tool"><asp:button id="btn_bc2" runat="server" CssClass="button" Width="65px" Text="保 存" style="DISPLAY:none"></asp:button><asp:button id="btn_tj2" runat="server" CssClass="button" Width="65px" Text="录入完毕"></asp:button><input type="button" value="关  闭" class="button" Width="65px" onclick="window.opener=null;window.close();"></div>
																					</FONT>
																				</TD>
																			</tr>
																			<TR bgColor="#ffffff">
																				<TD vAlign="top" colSpan="2" height="100%"><asp:textbox id="TabSelectedIndex" Runat="server" Visible="False" Text="0">0</asp:textbox><asp:textbox id="djb" style="DISPLAY: none" Runat="server"></asp:textbox><input class="button" id="btn_ts" type="button" value="显示" runat="server" style="DISPLAY:none">
