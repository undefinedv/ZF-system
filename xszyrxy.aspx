<%@ Page Language="vb" AutoEventWireup="false" Codebehind="xszyrxy.aspx.vb" Inherits="zjdx.xszyrxy"%>
...
<div id="main"> 
    ...
    <div id="content"> 
<asp:label id="Label3" runat="server" Width="100%" BackColor="#C0FFC0" BorderColor="Silver" BorderStyle="Groove">院系名称：</asp:label><BR>
				...
				<TABLE id="Table1" style="WIDTH: 712px; HEIGHT: 42px" cellSpacing="0" cellPadding="0" width="712" border="0">
					<TR>
