<%@ Page Language="vb" AutoEventWireup="false" Codebehind="xsezybm.aspx.vb" Inherits="zjdx.xsezybm" %>
				...
				<div id="content">
					<TABLE id="Tab" width="650" align="center">
						<TR align="center">
							<TD>
								<P>&nbsp;</P>
								<P><asp:label id="xxmc" runat="server" Font-Size="Large" Font-Bold="True"></asp:label><STRONG><FONT size="4">第二</FONT></STRONG><span style="FONT-WEIGHT: bold; FONT-SIZE: large">专业报名表</span></P>
								<P>&nbsp;</P>
							</TD>
						</TR>
					</TABLE>
					...
					<TABLE class="tbkb" id="Table1" width="650" align="center">
						...
						<TR>
							<TD height="3"><asp:label id="kc12" runat="server">&nbsp;</asp:label></TD>
							<TD height="3"><asp:label id="cj12" runat="server">&nbsp;</asp:label></TD>
							<TD height="3"><asp:label id="kc22" runat="server">&nbsp;</asp:label></TD>
							<TD height="3"><asp:label id="cj22" runat="server">&nbsp;</asp:label></TD>
						</TR>
						<TR>
						...
						<TR>
							<TD height="1"><asp:label id="kc15" runat="server">&nbsp;</asp:label></TD>
							<TD height="1"><asp:label id="cj15" runat="server">&nbsp;</asp:label></TD>
							<TD height="1"><asp:label id="kc25" runat="server">&nbsp;</asp:label></TD>
							<TD height="1"><asp:label id="cj25" runat="server">&nbsp;</asp:label></TD>
						</TR>
						<TR>
