		...
		<FORM id="Form1" method="post" runat="server">
			...
			<div id="main">
				...
				<div id="content">亲爱的同学：<BR>
					...
					<asp:label id="Label1" runat="server" Font-Bold="True" ForeColor="Red" Visible="False">该门课程只须评一个教师</asp:label>&nbsp;&nbsp;
					<asp:label id="Label2" runat="server" Visible="False">课程类型：</asp:label>&nbsp;
