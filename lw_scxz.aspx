<%@ Page Language="vb" AutoEventWireup="false" Codebehind="lw_scxz.aspx.vb" Inherits="zjdx.lw_scxz"%>
...
<div id="main"> 
    <div id="title"> 
      <div id="title_l"></div> 
      <div id="title_m">论文_摸板上传</div> 
      <div id="title_r"></div> 
    </div> 
    <div id="content"> <TABLE width="100%" class="tb" id="Table1">
                      <TR class="trbg1"> 
                        <TD>下载材料ID： 
                          <asp:textbox id="ggid" runat="server" ReadOnly="True"></asp:textbox> </TD>
                      </TR>
                      <TR> 
                        <TD> 材料标题： 
                      ...
                      <TR> 
                        <TD>请选择上传到服务器的文件名称：&nbsp;&nbsp;&nbsp;&nbsp; <INPUT id="loFile" type="file" name="loFile" runat="server"> 
                          <asp:checkbox id="CheckBox1" runat="server" Width="304px" Text="是否允许同名文件覆盖" Visible="False"></asp:checkbox> </TD>
                      </TR>
                      <TR class="trbg1"> 
                        <TD>
                          <!--请输入上传到服务器的目录名称：-->
                    ...
                    <asp:datagrid id="DataGrid1" runat="server" Width="100%" AutoGenerateColumns="False" AllowSorting="True" GridLines="none" CellPadding="3" CssClass="datagridstyle">
				<AlternatingItemStyle CssClass="datagrid1212"></AlternatingItemStyle>
			<HeaderStyle CssClass="datagridhead"></HeaderStyle>
				<Columns>
                        <asp:BoundColumn DataField="ggbt" HeaderText="材料标题"></asp:BoundColumn>
                        <asp:BoundColumn DataField="ggzw" HeaderText="材料正文"></asp:BoundColumn>
                        ...
                        <asp:BoundColumn Visible="False" DataField="id" HeaderText="材料ID"></asp:BoundColumn>
                        </Columns>
			</asp:datagrid></div> 
</div> 
<div id="bottom"> 
