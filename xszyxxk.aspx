<%@ Page Language="vb" AutoEventWireup="false" Codebehind="xszyxxk.aspx.vb" Inherits="zjdx.xszyxxk" %>
...
<div id="main"> 
    ...
    <div id="content">
<asp:label id="Label3" runat="server" BorderStyle="Groove" BorderColor="Silver" BackColor="#C0FFC0" Width="100%">院系名称：</asp:label><BR>
				...
				<TABLE id="Table1" style="WIDTH: 712px; HEIGHT: 38px" cellSpacing="0" cellPadding="0" width="712" border="0">
					<TR>
