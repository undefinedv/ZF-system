<%@ Page Language="vb" AutoEventWireup="false" Codebehind="js_tykwhgbzbkcjlr.aspx.vb" Inherits="zjdx.js_tykwhgbzbkcjlr"%>
						...
						<Columns>
							...
							<asp:TemplateColumn HeaderText="补考成绩">
								<ItemTemplate>
									...
									<ASP:DROPDOWNLIST id="dcj" runat="server"></ASP:DROPDOWNLIST>
								</ItemTemplate>
							</asp:TemplateColumn>
