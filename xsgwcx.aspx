<%@ Page Language="vb" AutoEventWireup="false" Codebehind="xsgwcx.aspx.vb" Inherits="zjdx.xsgwcx" %>
...
<div id="main"> 
    ...
    <div id="content">	<TABLE id="Table1" width="100%">
                      ...
                      <TR> 
                        <TD align="center">
                          <asp:button id="Button3" runat="server" Text="查　看" CssClass="button"></asp:button>
